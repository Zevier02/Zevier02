![Banner](https://zevier.fr/images/banner.png)
...
- I like playing video games and mainly **rhythm games** like [Osu!](https://osu.ppy.sh/users/30031700) or Geomtry Dash (even if i dropped now) and **[watch animes](https://myanimelist.net/profile/Thevier)**.
...
## 📌 What am i doing now ?
- Trying to experience something else, i am now working on **my own games** : in lua using Roblox Studio and in the Godot Engine.
- I am also always working on some **discord bots**.
- I update zevier.fr and add content and projects at *random times*.
...
- I'm available at [@zevier:matrix.org](https://matrix.to/#/@zevier:matrix.org).
